...
<li><a href="../exo-09/exo-09.html">9 distributeur</a></li>
...
<li><a href="../exo-21-juste-prix/exo21.html">21 Juste Prix 2</a></li>
</ul>
`;
...
document.body.addEventListener("moseover", () => {
  document.querySelector("#menu").classList.remove("menu-grid");
});
