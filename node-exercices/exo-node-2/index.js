...
function getJson() {
  ...
  /*
  csvStream.write({ Section: "row1-col1", Moyenne: "row1-col2" });
  csvStream.write({ Section: "row2-col1", Moyenne: "row2-col2" });
  csvStream.write({ Section: "row3-col1", Moyenne: "row3-col2" });
  csvStream.write({ Section: "row4-col1", Moyenne: "row4-col2" });
*/
  csvStream.end();
}
getJson();
