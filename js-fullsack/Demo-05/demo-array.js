...
const matrice1 = [['a', 'b', 'c', 'd'], ['z','y' ,'x' ,'w']];
...
const tableauDuck = ['Zaza', 'Riri', 'Donald', 'Gontran', 'Balthy', 'Les raptoux', 'Archibald', 'Della'];
...
const t4 = numberTab2.sort(function (a, b) { return a - b })
// Array(10) [ -3.2, 1, 2, 2.5, 5, 5.5, 10, 22, 42, 100 ]
const t5 = numberTab2.sort(function (a, b) { return b - a })
...
const t6 = numberTab3.toSorted(function (a, b) { return a - b}); 
// Array(10) [ -3.2, 1, 2, 2.5, 5, 5.5, 10, 22, 42, 100 ]
...
const tableauStudent = ['Fred', 'Yanis', 'Tom', 'Mussa', 'Antoine', 'Saskya', 'Alain', 'Mike', 'Billy']

// - Obtenir les personnes avec la lettre 'i'
const t8 = tableauStudent.filter(function(name) { return name.includes('i'); });

// - Obtenir les personnes avec un prénom de 4 lettre ou moins
const t9 = tableauStudent.filter(function(name) { return name.length <= 4; });


// Méthode qui permet d'appliquer une modiciation sur les données d'un tableau
const tableauTeacher = ['Aurélien', 'Khun', 'Alex', 'Michaël', 'Aude', 'Mélanie', 'Florence', 'Caroline'];

// - Mettre tout les prenoms en majuscule
const t10 = tableauTeacher.map(function(name) { return name.toLocaleUpperCase('fr-be'); });