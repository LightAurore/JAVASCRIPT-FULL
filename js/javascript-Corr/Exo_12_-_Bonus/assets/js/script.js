...
(() => {
    ...
    function createCard(cardId) {
        ...
        cardContentFront.className = 'front';
        const cardContentBack = document.createElement('div');
        cardContentBack.className = 'back';
    ...
    function onCardClick(event) {
        ...
        showCard(cardElement, cardValue);
    ...
    function showCard(cardElement, value) {
        ...
        const cardFront = cardElement.querySelector('.front');
        const urlImg = `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${value}.png`;
        cardFront.style.backgroundImage = `url("${urlImg}")`;
    }
